...
Normally, when you open a YouTube video URL in your desktop browser, there are several UX problems:
...
Save `youtube.html` from this repository in a convient place on your desktop. (For example, in `~/Apps/youtube-quick-loader`.)

Open the saved HTML file in your browser. The page will display "Title" and "URL" parameters for installing this page as a search engine in your browser. Follow the appropriate procedure for creating a new search engine in your browser with these parameters.
